...
export const PET_TYPES = {
  penguin: {
    ...
    walkSrc: "/assets/pets/penguin-walk-v4.webp",
    accent: "#9fc7ea"
  },
  purpleDragon: {
    name: "紫晶小龙",
    src: "assets/pets/purple-dragon-v2.png",
    walkSrc: "/assets/pets/purple-dragon-walk-v4.webp",
    walkScale: 1.2,
    accent: "#9b6ee8"
  },
  greenDino: {
    ...
    walkSrc: "/assets/pets/green-dino-walk-v4.webp",
    accent: "#94bd55"
  },
  chick: {
    name: "奶油小鸡",
    src: "assets/pets/chick-v2.png",
    walkSrc: "/assets/pets/chick-walk-v4.webp",
    accent: "#f3c34a"
  }
};
